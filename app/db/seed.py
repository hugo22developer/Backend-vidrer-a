...
async def seed_initial_data(session: AsyncSession) -> None:
    ...
    posts = [
        BlogPost(id="b1", slug="fachadas-muro-cortina", category="Tendencias", title="Fachadas de muro cortina: la nueva piel de la arquitectura comercial", excerpt="Por qué cada vez más despachos eligen envolventes de vidrio estructural sobre mampostería tradicional.", content="Contenido completo del artículo sobre fachadas de muro cortina...", accent="from-accent2/30 to-surface", status="published", date=date(2026, 6, 2), views=1840),
        BlogPost(id="b2", slug="mantenimiento-canceles-bano", category="Mantenimiento", title="Cómo alargar la vida útil de tus canceles de baño", excerpt="Limpieza, lubricación de rieles y señales tempranas de desgaste en herrajes y sellos.", content="Contenido completo del artículo sobre mantenimiento de canceles...", accent="from-accent/25 to-surface", status="published", date=date(2026, 5, 18), views=2960),
        BlogPost(id="b3", slug="dvh-vs-vidrio-simple", category="Guía técnica", title="DVH vs. vidrio simple: qué gana realmente tu factura eléctrica", excerpt="Comparativa real de aislamiento térmico entre sistemas de doble y triple acristalamiento.", content="Contenido completo del artículo sobre DVH vs vidrio simple...", accent="from-ink-muted/25 to-surface", status="draft", date=date(2026, 7, 10), views=410),
    ]
    insumos = [
